    ...
    <section id="about" className="min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 relative overflow-hidden">
      <FadeIn delay={0.1} x={-80} y={0} duration={0.9} className="absolute top-[4%] left-[1%] sm:left-[2%] md:left-[4%] z-0">
        <img
          ...
          alt="Moon icon"
          className="w-[120px] sm:w-[160px] md:w-[210px] h-auto pointer-events-none opacity-60"
        />
      </FadeIn>
      ...
      <FadeIn delay={0.25} x={-80} y={0} duration={0.9} className="absolute bottom-[8%] left-[3%] sm:left-[6%] md:left-[10%] z-0">
        <img
          ...
          alt="3D object"
          className="w-[100px] sm:w-[140px] md:w-[180px] h-auto pointer-events-none opacity-60"
        />
      </FadeIn>
      ...
      <FadeIn delay={0.3} x={80} y={0} duration={0.9} className="absolute bottom-[8%] right-[3%] sm:right-[6%] md:right-[10%] z-0">
        <img
          ...
          alt="3D group"
          className="w-[130px] sm:w-[170px] md:w-[220px] h-auto pointer-events-none opacity-60"
        />
      </FadeIn>
      ...
      <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 max-w-4xl w-full relative z-10">
        ...
        <FadeIn delay={0.3} y={20}>
          <ContactButton href="#footer" label={t.about.cta} />
        </FadeIn>
      </div>
    </section>
  );
